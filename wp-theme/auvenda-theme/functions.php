...
add_action('acf/init', function() {
    ...
    if (function_exists('acf_add_local_field')) acf_add_local_field(array('key'=>'f_hero_background','label'=>'Background image','name'=>'hero_background','type'=>'image','return_format'=>'id','library'=>'all','parent'=>'group_auvenda_frontpage','menu_order'=>7));
});
